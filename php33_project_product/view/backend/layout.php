      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="admin.php?controller=category_product">Danh mục san pham</a></li>
            <li class="active"><a href="admin.php?controller=product">San pham</a></li>
            <li class="active"><a href="admin.php?controller=order">Quan ly don hang</a></li>
