...
<div class="container mt-3">
  <div class="row">
    <div class="col-sm">
      <div class="card">
        <div class="card-header bg-primary text-white text-uppercase"> <i class="fa fa-star"></i> Sản phẩm noi bat </div>
        <div class="card-body">
          <div class="row"> 
            <?php  
            //lay cac san pham noi bat: field c_hotproduct=1
            $product=$this->model->get_all("select * from tbl_product where c_hotproduct=1 order by pk_product_id desc limit 0,4");
            ...
            <div class="col-sm">
              <div class="card"> <img class="card-img-top" src="public/upload/product/<?php echo $rows->c_img; ?>" alt="Card image cap">
                <div class="card-body">
                  ...
                  <div style="height:300px; overflow: hidden;"><p class="card-text text-justify"><?php echo $rows->c_description; ?></p></div>
                  <div class="row">
                    <div class="col">
